#ifndef ECOL_STATION_NEIGHBOUR_BS_H
#define ECOL_STATION_NEIGHBOUR_BS_H

enum {
	ORWNEIGHBOUR = 5,
	TIMER_PERIOD_MILLI = 555,
...
#define CTPDATASIZE (sizeof(NeiCTPMsg)+2)

#endif /* ECOL_STATION_NEIGHBOUR_BS_H */
